...
static PyTypeObject RadauDenseEvaluatorType = {
    ...
    .tp_name = "pyRadau.RadauDenseEvaluator",
...
static PyMethodDef methods[] = {
	{"radau", (PyCFunction)radau, METH_VARARGS | METH_KEYWORDS,
		"Solve an ODE system using the RADAU integrator\n\n"
		"Syntax: radau(rhs_fn, y0, t, initial_order=13, max_steps=10000,\n"
...
static struct PyModuleDef moduledef = {
        ...
        "pyRadau",
        "Python wrapper around the RADAU integrator",
        -1,
        methods
};

PyObject * PyInit_pyRadau(void) {
#else
PyMODINIT_FUNC initpyRadau(void) {
#endif
...
#else
	(void)Py_InitModule("pyRadau", methods);
#endif
